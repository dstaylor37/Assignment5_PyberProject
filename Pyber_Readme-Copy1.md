...
The assignment was created using Jupyter Notebook, Pandas and Numpy Python libraries as well as GitHub and StackOverview. Mapplotlib was used to create the visualizations.
